                ...
                <div class="container overflow-hidden flex flex-col lg:flex-row justify-between mx-auto px-4">
                    ...
                    <div class="w-3/4 block sm:flex text-sm mt-6 lg:mt-0">
                        <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                            <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">About Us</li>
                            <li><Link to={'/'} class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Home</Link></li>
                            <li><Link to={'/about-us'} class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">About US</Link></li>
                            <li><Link to={'/cart'} class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Cart</Link></li>
                            <li><Link class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">FAQ</Link></li>
                        </ul>
                        <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                            <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Our Services</li>
