    ...
    return (
        <>
            ...
            <section class="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5">
                <ProductDetail cartContity={cartContity} setCartContity={setCartContity} apiProductsList={apiProductsList}></ProductDetail>
            </section>
...
function ProductDetail({ cartContity, setCartContity, apiProductsList }) {
    // let {category,brand,price,thumbnail} = apiProductsList;
    return (
        <>
            {
                apiProductsList.map((item, index) => {

                    return (

                        <>

                            <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl" key={index}>
                                <a href="#">
                                    ...
                                    <div class="px-4 py-3 w-72">
                                        ...
                                        <p class="text-lg font-bold text-black truncate block capitalize">{item.brand}</p>
